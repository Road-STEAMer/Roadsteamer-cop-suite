...
ActiveRecord::Schema.define(version: 2024_06_03_172352) do
  ...
  create_table "saved_datasets", force: :cascade do |t|
    ...
    t.string "url"
    t.string "dataset_id"
    t.index ["decidim_user_id", "dataset_id"], name: "index_saved_datasets_on_user_and_dataset_id", unique: true
